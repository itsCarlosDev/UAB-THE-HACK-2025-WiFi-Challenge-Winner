...
FILE_APS = ROOT_DIR / "data" / "demo" / "rookie_filtered_aps.json"
FILE_CLIENTS = ROOT_DIR / "data" / "demo" / "rookie_filtered_clients.json"

MAPS_DIR = ROOT_DIR / "apps" / "frontend" / "maps"
MAPS_DIR.mkdir(parents=True, exist_ok=True)

OUTPUT_MAP_HEALTH = MAPS_DIR / "mapa_health_dinamico.html"
OUTPUT_MAP_SIGNAL = MAPS_DIR / "mapa_signal_dinamico.html"
OUTPUT_MAP_CLIENTS = MAPS_DIR / "mapa_clientes_dinamico.html"
...
try:
    ...
    map_center_coords = [
        df_ap_locations["lat"].mean(),
        df_ap_locations["lon"].mean(),
    ]
...
all_times = sorted(
    df_master["timestamp_str"].dropna().unique().tolist()
)
